.PHONY: generate model structure test test-v36 test-v39 test-v43 synth-v36 synth-v39 synth-v43
...
synth-v36: generate
	bash scripts/run_synth.sh divider_v36rcm

synth-v39: generate
	bash scripts/run_synth.sh divider_v39c42

synth-v43: generate
	bash scripts/run_synth.sh divider_v43sj17
